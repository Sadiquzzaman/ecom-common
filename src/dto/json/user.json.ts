...
export const usersObject = [
  ...
  {
    firstName: 'simec',
    lastName: 'shop manager',
    email: 'shop_manager@simec.com',
    phone: '01957206217',
    password: 's1234',
    gender: Gender.Male,
    ...
    dateOfBirth: new Date(),
    address:
      'Shop manager Simec System Limited, 55, Shah Makhdum Avenue, Uttara-12, Dhaka, Bangladesh',
  },
];
