...
function backend() {
  ...
  # ecom-common
  git clone -b release/prod "git@bitbucket.org:simec-web/$ecom_common.git"
  cd $ecom_common
  ...
  # ecom-backend
  git clone -b release/prod "git@bitbucket.org:simec-web/$ecom_backend.git"
  cd $ecom_backend
...
function frontend() {
  ...
  # ecom-frontend
  git clone -b release/prod "git@bitbucket.org:simec-web/$ecom_frontend.git"
  cd $ecom_frontend
...
function solr() {
  ...
  cd $deploy_dir
  git clone -b release/prod git@bitbucket.org:simec-web/ecom-solr.git
